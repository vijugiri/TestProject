...
public class CollectionReport extends BaseClass{
	...
	String strval4=null;
		...
		public void verifyPatientReport(String SearchPatient,String FullName,String Disease,String MobNo,String EmailId, String Age,String Gender,String Weight,String Height,
		...
		
		{
			...
			objDashboardView.clickDashboardMenu();
			objreportview.verifyPatientReport(FullName);
			
		}
	

		@Test(priority = 4, dataProvider ="HappyFlow")
		public void verifyCollectionstReport(String SearchPatient,String FullName,String Disease,String MobNo,String EmailId, String Age,String Gender,String Weight,String Height,
		String State,String District,String City,String Note,String pulses,String Systolic,String diastolic,String repositoryRate,String temprature,String medicineNeme,String Dose,String Days,String ConsultingCharge ) throws InterruptedException

		{
			...
			logger.info("Patient closed Sucessfully");
			objDashboardView.clickDashboardMenu();
			objreportview.verifyCollectionReport(FullName, ConsultingCharge);
			objDashboardView.clickDashboardMenu();
	
	
		}
		@Test(priority=5)
		public void verifyGeneratePDFInCollectionReport() throws InterruptedException {
			objDashboardView.clickDashboardMenu();
			objreportview.clickOnCollectionReport();
			
			objreportview.verifyGeneratePdf();
		...
		public void verifySearchFunctionality(String SearchPatient,String FullName,String Disease,String MobNo,String EmailId, String Age,String Gender,String Weight,String Height,
		String State,String District,String City,String Note,String pulses,String Systolic,String diastolic,String repositoryRate,String temprature,String medicineNeme,String Dose,String Days,String ConsultingCharge ) throws InterruptedException

		{
			...
			objDashboardView.clickDashboardMenu();
			objreportview.clickOnCollectionReport();
			objreportview.enterNameInSearchField(FullName);
			objreportview.verifySearchFunctionality(FullName);
			objDashboardView.clickDashboardMenu();
		driver.close();
